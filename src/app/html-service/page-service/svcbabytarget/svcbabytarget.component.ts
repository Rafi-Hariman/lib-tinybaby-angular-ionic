      ...
      datasets: [
        {
          ...
          backgroundColor: [
            'rgba(101, 58, 252, 1)', // First color
            'rgba(248, 69, 117, 1)', // Second color
            'rgba(234, 236, 239, 1)', // Third color
            'rgba(54, 162, 235, 1)', // Fourth color (new)
            'rgba(75, 192, 192, 1)', // Fifth color (new)
            'rgba(153, 102, 255, 1)', // Sixth color (new)
          ],
          borderColor: [
            'rgba(101, 58, 252, 1)', // First border color
            'rgba(248, 69, 117, 1)', // Second border color
            'rgba(234, 236, 239, 1)', // Third border color
            'rgba(54, 162, 235, 1)', // Fourth border color (new)
            'rgba(75, 192, 192, 1)', // Fifth border color (new)
            'rgba(153, 102, 255, 1)', // Sixth border color (new)
          ],
